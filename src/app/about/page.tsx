  ...
  return (
    <>
      ...
      <SectionLayout eyebrow="COMPANY" title="회사소개" items={navItems}>
        {/* 인사말 */}
        <section id="sec-greeting" className="spy-section border-b border-[#eef1f5] px-5 py-16 lg:px-[60px] lg:py-[74px]">
          <div className="mb-4 font-mono text-[13px] tracking-[2px] text-[#0fb0c8]">GREETING · 인사말</div>
          <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:gap-[52px]">
            <div>
              <h2 className="m-0 mb-[26px] text-[26px] font-extrabold leading-[1.32] tracking-[-0.7px] text-[#0a1b33] lg:text-[30px]">
                고객 여러분께
                <br />
                깊은 감사를 드립니다
              </h2>
            ...
            <div>
              <div className="relative mb-4 flex min-h-[300px] items-center justify-center overflow-hidden rounded-[18px] bg-[linear-gradient(150deg,#0e2950,#0a1b33)]">
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_30%,rgba(15,176,200,0.28),transparent_55%)]" />
                <span className="relative font-mono text-[12px] text-[#9fb0c9]">대표 / 회사 이미지</span>
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div className="rounded-[14px] border border-[#eaeef3] bg-[#f6f9fb] p-5">
                  <div className="mb-1.5 font-mono text-[12px] text-[#0fb0c8]">SINCE</div>
                  <div className="text-[23px] font-extrabold text-[#0a1b33]">1996</div>
                </div>
                <div className="rounded-[14px] border border-[#eaeef3] bg-[#f6f9fb] p-5">
                  <div className="mb-1.5 font-mono text-[12px] text-[#0fb0c8]">CEO</div>
        ...
        {/* 회사소개 */}
        <section id="sec-info" className="spy-section border-b border-[#eef1f5] bg-[#fbfcfe] px-5 py-16 lg:px-[60px] lg:py-[74px]">
          <div className="mb-4 font-mono text-[13px] tracking-[2px] text-[#0fb0c8]">INFORMATION · 소개</div>
          <div className="mb-14 grid grid-cols-1 items-start gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:gap-[52px]">
            <div>
              <h2 className="m-0 mb-6 text-[26px] font-extrabold leading-[1.32] tracking-[-0.7px] text-[#0a1b33] lg:text-[30px]">
                1996년부터, 다이캐스팅
                <br />
                국산화의 길을 걸어왔습니다
              </h2>
            ...
            <div className="relative flex h-[260px] items-center justify-center overflow-hidden rounded-[18px] bg-[linear-gradient(150deg,#0e2950,#0a1b33)] lg:h-[340px]">
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_30%,rgba(15,176,200,0.28),transparent_55%)]" />
              <span className="relative font-mono text-[12px] text-[#9fb0c9]">공장 전경 / 생산 설비 이미지</span>
            </div>
          </div>
          <div className="grid grid-cols-1 gap-[18px] sm:grid-cols-3">
            {values.map((v) => (
              <div key={v.no} className="rounded-2xl border border-[#eaeef3] bg-white px-7 py-[30px]">
                <div className="mb-3 font-mono text-[34px] font-extrabold text-[#0fb0c8]">{v.no}</div>
        ...
        {/* 연혁 */}
        <section id="sec-history" className="spy-section px-5 py-16 lg:px-[60px] lg:py-[74px]">
          <div className="mb-4 font-mono text-[13px] tracking-[2px] text-[#0fb0c8]">HISTORY · 연혁</div>
          <h2 className="m-0 mb-2 text-[26px] font-extrabold leading-[1.3] tracking-[-0.7px] text-[#0a1b33] lg:text-[30px]">
            걸어온 길
          </h2>
            ...
            {history.map((h) => (
              <div key={h.year} className={`relative ${h.last ? "" : "mb-9"}`}>
                <div
                  ...
                  style={{ background: h.last ? "#0a1b33" : "#0fb0c8" }}
                />
                <div
                  className="mb-2.5 font-mono text-[22px] font-bold"
                  style={{ color: h.last ? "#0a1b33" : "#0fb0c8" }}
                >
                  {h.year}
                </div>
        ...
        {/* 오시는 길 */}
        <section id="sec-location" className="spy-section border-t border-[#eef1f5] px-5 py-16 lg:px-[60px] lg:py-[74px]">
          <div className="mb-4 font-mono text-[13px] tracking-[2px] text-[#0fb0c8]">LOCATION · 오시는 길</div>
          <h2 className="m-0 mb-[30px] text-[26px] font-extrabold tracking-[-0.7px] text-[#0a1b33] lg:text-[30px]">
            오시는 길
          </h2>
          <div className="relative mb-6 flex h-[300px] items-center justify-center overflow-hidden rounded-[18px] border border-[#e2e6ed] bg-[#eef2f6] lg:h-[380px]">
            ...
            <div className="relative text-center">
              <svg width="46" height="46" viewBox="0 0 24 24" fill="none" stroke="#0fb0c8" strokeWidth="2" className="mx-auto mb-3">
            ...
            <div className="grid grid-cols-1 gap-x-14 sm:grid-cols-2">
              {infoRows.map((r) => (
                <div key={r.k} className="flex gap-3.5 border-b border-[#f0f3f7] py-[15px] last:border-b-0 sm:[&:nth-last-child(-n+2)]:border-b-0">
                  <span className="w-[70px] shrink-0 text-[14px] font-bold text-[#0fb0c8]">{r.k}</span>
