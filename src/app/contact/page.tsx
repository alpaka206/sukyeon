...
export default function ContactPage() {
  return (
    <>
      ...
      <div className="grid grid-cols-1 items-start gap-12 px-5 py-16 pb-20 lg:grid-cols-[1.3fr_0.7fr] lg:px-[60px]">
        <ContactForm />

        <div className="flex flex-col gap-[18px]">
          <div className="relative overflow-hidden rounded-[18px] bg-[#0a1b33] p-8 text-white">
            <div className="pointer-events-none absolute -right-10 -top-[50px] h-[200px] w-[200px] rounded-full bg-[radial-gradient(circle,rgba(15,176,200,0.3),transparent_65%)]" />
            <h3 className="relative m-0 mb-[18px] text-[20px] font-extrabold">전화 문의</h3>
            <a href="tel:032-575-2492" className="relative mb-1.5 block text-[26px] font-extrabold text-[#0fb0c8]">
              032-575-2492
            </a>
            <div className="relative text-[14px] text-[#b6c3d6]">FAX 032-575-2493</div>
            <a href="mailto:sukyeonmro@naver.com" className="relative mt-1 block text-[14px] text-[#0fb0c8]">
          ...
          <div className="rounded-[18px] border border-[#eaeef3] p-8">
            ...
            <Link href="/about#sec-location" className="link-teal text-[14px] font-bold text-[#0a8499]">
              지도 보기 →
            </Link>
          </div>
        </div>
