...
const formSchemas: Readonly<Record<string, FormField>> = {
  homePage: object({
    ...
    productsHeading: object({ eyebrow: stringField, title: stringField, moreLabel: stringField, moreHref: urlField }),
    ...
    whyHeading: object({ eyebrow: stringField, title: stringField }),
  ...
  productLineup: object({
    key: required({ kind: "string", values: ["release", "pranza"] }), eyebrow: stringField, title: required(stringField), brand: stringField, intro: stringField, bullets: array(stringField),
  ...
  productGallery: object({
    key: required({ kind: "string", values: ["machine-parts", "spray", "crucible"] }), eyebrow: stringField, title: required(stringField), intro: stringField,
  ...
  cert: object({ title: required(stringField), eyebrow: stringField, standard: stringField, desc: stringField, issuer: stringField, number: stringField, scope: stringField, validity: stringField, imageKo: imageField, imageEn: imageField, order: numberField }),
};
